...
export default function LandingPage() {
  return (
    <BackgroundLines className="flex min-h-screen flex-col bg-background text-foreground">
        ...
        <section className="relative px-4 py-28 md:px-8">
          <div className="mx-auto max-w-6xl">
            <div className="mb-16 text-center">
              ...
              <p className="mx-auto max-w-2xl text-muted-foreground">
                Learn about the advanced Deep Image Prior (DIP) techniques we
                use to enhance your images.
              </p>
            </div>
            ...
            <div className="grid gap-12">
                ...
                <div className="grid gap-8 md:grid-cols-2">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      components that work together to progressively remove
              ...
              <div className="grid gap-8 md:grid-cols-2">
                ...
                >
                  ...
                  <p className="text-muted-foreground">
                    Our system uses advanced histogram thresholding techniques
                    to separate signal from noise in fluorescence microscopy
                    images. This approach is particularly effective for images
                    with distinct intensity distributions between the background
                    noise and the fluorescent signals of interest.
                  </p>
                </ShinyCard>
                ...
                >
                  ...
                  <p className="text-muted-foreground">
                    Our algorithm based on DIP and Histogram, adapts to
                    different types of microscopy images and noise patterns. It
                    automatically detects the characteristics of your specific
                    image and applies the optimal combination of processing
                    techniques to achieve the best outcome based on input.
                  </p>
                </ShinyCard>
              </div>
            </div>
